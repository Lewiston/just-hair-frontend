...
import stylist from "@/public/stylist.jpg";
...
const StylistCard = () => {
  ...
  return (
    <div className="flex flex-col rounded-2xl bg-neutral-50 border border-neutral-100 shadow-xs overflow-clip">
      <Image src={stylist} alt="" className="h-40 w-auto object-cover" />
      <div className="p-4 flex flex-col gap-2">
        <div className="flex justify-between items-start">
          <div className="flex flex-col">
            ...
            <p className="text-neutral-500 text-sm">Hair Colorist & Stylist</p>
          </div>
        ...
        <div className="flex gap-1 items-center">
          ...
          <p className="text-neutral-500 text-sm">4.9 (127 reviews)</p>
        </div>
        ...
        <div className="flex justify-between items-center">
          <span className="font-black text-base text-violet-500">
            From 2500 XAF
          </span>
          <div className="flex gap-1 items-center">
