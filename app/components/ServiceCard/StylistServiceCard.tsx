  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 items-center justify-center absolute right-3 top-3">
        <FaRegEdit className="h-5 w-5 text-violet-600 hover:scale-[1.2] cursor-pointer" />
        <AiOutlineDelete className="h-5 w-5 text-red-600 hover:scale-[1.2] cursor-pointer" />
      </div>
