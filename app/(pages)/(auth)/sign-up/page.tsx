...
import client from "@/public/images/auth/client_user.jpg";
...
const SignUp = () => {
  ...
  const handleCreateAccount = (event: React.MouseEvent) => {
    ...
    if (!userAccount.retype_password) {
    ...
    if (userAccount.password !== userAccount.retype_password) {
    ...
    <div className="relative">
      {!create && (
        <div className="grid sm:grid-cols-2 md:grid-cols-2 h-dvh w-dvw">
          <div className="left-hand p-10 flex flex-col justify-center">
            <div className=" max-w-[720px] mx-auto flex flex-col gap-16 sm:gap-32 justify-center z-20">
          ...
          <div className="flex items-center justify-center">
            <div className="right-hand  w-full max-w-[720px] p-10 flex flex-col gap-12 justify-center items-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-6 w-full max-w-[800px]">
                  {/* Email Label */}
                  <div className="flex flex-col gap-1 w-full max-w-[800px]">
                    <label
                      htmlFor=""
      ...
      {create && (
        <div className="absolute top-0 left-0 h-dvh w-dvw bg-neutral-50 z-100">
          <div className="grid sm:grid-cols-2 md:grid-cols-2 h-full w-full">
